...
async function seed() {
    console.log('--- Starting Seeding (v2: No Storage) ---');

    let createdCount = 0;

    for (const s of STUDENTS) {
        // Unique email just in case
        ...
        // Wait a moment for trigger (if any, though we are doing manual insert)
        ...
        if (profileError) {
            ...
            // If error is "duplicate key" or something, we skip
        } else {
